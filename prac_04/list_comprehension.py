...
numbers = [int(temp_number) for temp_number in almost_numbers]
print(numbers)

# TODO: use a list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
number_above_nine = [temp_number for temp_number in numbers if temp_number > 9]
print(number_above_nine)